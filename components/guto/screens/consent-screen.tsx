...
const consentCopy: Record<string, {
  ...
  "es-ES": {
    ...
    subtext: "Lee y confirma abajo para continuar.",
    aiTitle: "GUTO es una IA",
    aiBody: "GUTO es un asistente digital con inteligencia artificial. Ayuda con entrenamiento, dieta y rutina, pero no reemplaza la evaluación médica, nutricional o profesional presencial.",
    dataTitle: "Uso de datos de salud y fitness",
    dataBody: "Para generar entrenamientos, dietas y seguimiento, GUTO utiliza datos como peso, altura, objetivos, limitaciones, patologías, restricciones alimentarias e historial de entrenamiento.",
    safetyTitle: "Responsabilidad",
    safetyBody: "Si sientes dolor, mareos, malestar o tienes alguna condición médica, interrumpe el entrenamiento y busca un profesional.",
    checkHealth: "He leído y acepto que GUTO use mis datos de salud/fitness para generar entrenamiento, dieta y seguimiento.",
    checkTerms: "He leído y acepto los",
