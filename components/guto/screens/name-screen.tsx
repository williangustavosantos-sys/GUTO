...
export function NameScreen({ onSubmit, language }: NameScreenProps) {
  const [name, setName] = useState("")
  const locale = localeTexts[language || "pt-BR"]
  const completeText = locale.complete
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05, backgroundColor: "oklch(0.65 0.15 240 / 0.2)" }}
            whileTap={{ scale: 0.95 }}
          >
