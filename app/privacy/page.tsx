...
const privacyCopy: Record<Lang, {
  ...
  "pt-BR": {
    ...
    sections: [
      ...
      { heading: "4. Onde os dados são armazenados", body: "Os dados são armazenados no backend do GUTO e, localmente, no dispositivo do usuário via localStorage do navegador. O armazenamento segue as práticas padrão do setor de proteção de dados." },
  ...
  "en-US": {
    ...
    sections: [
      ...
      { heading: "4. Where data is stored", body: "Data is stored in the GUTO backend and, locally, on the user's device via browser localStorage. Storage follows industry-standard data protection practices." },
  ...
  "it-IT": {
    ...
    sections: [
      ...
      { heading: "4. Dove vengono archiviati i dati", body: "I dati sono archiviati nel backend di GUTO e, localmente, sul dispositivo dell'utente tramite localStorage del browser. L'archiviazione segue le pratiche standard del settore per la protezione dei dati." },
